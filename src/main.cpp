...
namespace mdn {
    ...
    MenuItem mainMenu[] = { // Menu items
        {"CLI", run_cli},
        {"GUI", run_gui},
        {"Exit", [](){mdn::exitApp = true; return 0;}},
    };
    ...
    short to_ncurses_color(int hex_component) {
    ...
    void print_main_menu(WINDOW *menu_win, int highlight) {
        ...
        wborder_set(menu_win,
                    &mdn::vline, &mdn::vline, &mdn::hline, &mdn::hline,
                    &mdn::rounded_ul, &mdn::rounded_ur, &mdn::rounded_ll, &mdn::rounded_lr);
